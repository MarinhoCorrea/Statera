import { PostTutorService, PatchTutorService, GetTutorById } from '../services/tutorService.js';
...
export const GetTutorById = async (req, res) => {
    ...
    if (tutorIdUrl !== tutorIdToken) {
        return res.status(403).json({ erro: "Você não tem permissão para visualizar este perfil." });
    }
